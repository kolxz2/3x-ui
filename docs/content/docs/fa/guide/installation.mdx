...
[صفحهٔ releases](https://github.com/kolxz2/3x-ui/releases) دانلود کنید، آن را
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/kolxz2/3x-ui/master/install.sh)
```

دایرکتوری [`deploy/`](https://github.com/kolxz2/3x-ui/tree/main/deploy) در مخزن
